...
Added on $ Jun, 2025: New version of mbX will have two more added functions -ezstat and ezfest. ezstat does the heavy lifting of the statistical analysis of data.
